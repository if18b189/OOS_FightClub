...
void Fighter::attack(Fighter& enemy){ //ampersand stands for a reference
    ...
    if(this->dead != true){
        ...
        cout << this->name << " greift an und macht " << hitpoints << " Schaden" << endl;
        cout << enemy.name << " hat " << enemy.healthPoints << " Healthpoints"  << "\n" << endl;
...
void create(Fighter *fighter[]){
    ...
    cout << "Alle Kaempfer wurden erfolgreich erstellt und sind nun bereit." << endl;
}
...
void pick(Fighter *arrayname[]){
    ...
    cout << "Kaempfer 1 waehlen: " << endl;
    cin >> fighter1;
    cout << "Kaempfer 2 waehlen: " << endl;
    cin >> fighter2;
