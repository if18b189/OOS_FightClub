...
class Fighter
{
	...
	public:
#else
	protected:  //nur kinderklassen koennen zugreifen
                //private kann nur das objekt selbst
#endif
...
public:
    ...
    virtual double specialAttack() = 0; // virtual bedeuted ...
    virtual double specialDefense() = 0;//...wird in unterklasse definiert
    void attack(Fighter&);
